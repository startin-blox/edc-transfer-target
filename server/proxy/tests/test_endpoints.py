...
class JSONToFileTests(TestCase):
    ...
    def test_save_json_file_error(self):
        ...
        data = {'message': 'Hello, world!'}
        response = self.client.post('/json-to-file/{}/'.format(filename), json.dumps(data), content_type='application/pdf')
...
class FileToJSONTests(TestCase):
    ...
    def test_load_json_file_success(self):
        ...
        filename = 'test_file.json'
        response = self.client.get('/file-to-json/{}/'.format(filename))
